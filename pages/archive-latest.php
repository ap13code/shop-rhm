...
<p class="my-2"> مرتب سازی براساس : <a href="archive.php" class="btn btn-primary" style="font-size:14px;">قدیمی ترین</a></p>
        ...
        <table class="table">
            ...
            <?php
            $i=1;
            $all_fields = mysqli_query($con, "SELECT * FROM `product` ORDER BY pid DESC");
